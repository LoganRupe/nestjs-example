...
MONGODB_ADMIN_PASS=${MONGODB_ADMIN_PASS:-"example123"}

# Application Database User
MONGODB_APPLICATION_DATABASE=${MONGO_NEST_DATABASE:-"nest"}
MONGODB_APPLICATION_USER=${MONGO_NEST_USERNAME:-"nest"}
MONGODB_APPLICATION_PASS=${MONGO_NEST_PASSWORD:-"NestPassword123"}
